...
class TestSanitizeName:
    ...
    def test_keyword_handling(self) -> None:
    ...
    def test_digit_prefix_handling(self) -> None:
...
class TestUpdateRefs:
    ...
    def test_simple_ref_update(self) -> None:
    ...
    def test_nested_ref_update(self) -> None:
    ...
    def test_array_ref_update(self) -> None:
    ...
    def test_deeply_nested_array_ref_update(self) -> None:
    ...
    def test_mixed_type_structures_ref_update(self) -> None:
    ...
    def test_update_refs_error_conditions(self) -> None:
...
class TestGetApiName:
    ...
    def test_api_name_extraction(self) -> None:
...
class TestBuildModelsIntegration:
    ...
    def create_minimal_openapi_spec(self, api_name: str = "TestAPI") -> dict[str, Any]:
    ...
    def test_minimal_spec_processing(self) -> None:
    ...
    def test_build_with_temp_directory(self) -> None:
...
class TestMappingsImport:
    ...
    def _load_tfl_mappings_or_skip(self) -> dict[str, Any]:
    ...
    def _validate_mapping_structure(self, api_mappings: dict[str, Any], api_name: str) -> None:
    ...
    def test_mappings_import(self) -> None:
    ...
    def test_known_api_mappings_structure(self, api_name: Any) -> None:
    ...
    def _get_api_mappings_or_skip(self, tfl_mappings: dict[str, Any], api_name: str) -> dict[str, Any]:
...
class TestCreateEnumClass:
    ...
    def test_basic_enum_creation(self) -> None:
    ...
    def test_enum_with_special_characters(self) -> None:
    ...
    def test_enum_with_empty_values(self) -> None:
...
class TestMapType:
    ...
    def test_ref_mapping(self) -> None:
...
class TestGetPydanticImports:
    ...
    def test_base_model_imports(self) -> None:
    ...
    def test_root_model_imports(self) -> None:
...
class TestGetModelConfig:
    ...
    def test_generic_response_model_config(self) -> None:
    ...
    def test_regular_model_config(self) -> None:
...
class TestSanitizeFieldName:
    ...
    def test_regular_field_names(self) -> None:
    ...
    def test_keyword_field_names(self) -> None:
...
class TestGetBuiltinTypes:
    ...
    def test_builtin_types_returned(self) -> None:
...
class TestTopologicalSort:
    ...
    def test_simple_dependency_graph(self) -> None:
...
class TestJoinUrlPaths:
    ...
    def test_basic_path_joining(self) -> None:
...
class TestClassifyParameters:
    ...
    def test_only_path_parameters(self) -> None:
    ...
    def test_only_query_parameters(self) -> None:
...
class TestCreateSchemaNamMapping:
    ...
    def test_basic_schema_mapping(self) -> None:
...
class TestBuildModelsRealIntegration:
    ...
    def test_build_models_with_real_specs(self) -> None:
    ...
    def test_generated_models_syntax_valid(self) -> None:
